...
from modules.game import DeckFunctions
...
class Interactions(commands.Cog):
    ...
    async def draw(self,interaction: discord.Interaction):
      await interaction.response.send_message(DeckFunctions.random_draw())
    ...
    async def draw_with_mod(self,interaction: discord.Interaction, trait:int, bless:str):
      await interaction.response.send_message(DeckFunctions.random_draw_with_modifier(trait, bless))
    ...
    async def draw_with_trait(self,interaction: discord.Interaction, trait:int):
      await interaction.response.send_message(DeckFunctions.random_draw_with_trait(trait))
